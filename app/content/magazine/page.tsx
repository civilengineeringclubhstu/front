      ...
      <div className="container mx-auto px-6 max-w-3xl flex flex-col items-center text-center">
        ...
        <div className="w-full mt-8 flex flex-col items-center gap-12">
          <div className="relative w-full max-w-sm">
            ...
            {isOpen && (
              <div className="absolute top-full left-0 right-0 mt-2 p-2 bg-white/95 dark:bg-[#141923]/95 border border-black/10 dark:border-white/10 backdrop-blur-xl shadow-2xl rounded-2xl z-20 flex flex-col gap-1">
                {MAGAZINES.map(mag => (
                  <button
                    key={mag.id}
          ...
          >
             ...
             <button className="btn-primary flex items-center justify-center text-lg h-[64px] px-10">
