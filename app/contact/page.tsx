            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="font-semibold">contact@clubplatform.edu</p>
                </div>
              </div>
            ...
            <form onSubmit={handleSubmit} className="glass p-8 md:p-12 rounded-[36px] flex flex-col gap-6">
              <div className="grid md:grid-cols-2 gap-6">
                <div className="flex flex-col gap-2">
                  ...
                  <input type="text" required className="input-glass" placeholder="John" />
                </div>
                <div className="flex flex-col gap-2">
                  <label className="text-sm font-bold ml-2">Last Name</label>
                  <input type="text" required className="input-glass" placeholder="Doe" />
                </div>
              </div>
              
              <div className="flex flex-col gap-2">
                <label className="text-sm font-bold ml-2">Email Address</label>
                <input type="email" required className="input-glass" placeholder="john@example.com" />
              </div>
              
              <div className="flex flex-col gap-2">
                <label className="text-sm font-bold ml-2">Subject</label>
                <input type="text" required className="input-glass" placeholder="How can we help?" />
              </div>
